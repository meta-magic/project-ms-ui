(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/router'), require('@angular/forms'), require('amexio-ng-extensions'), require('@angular/common/http'), require('platform-commons'), require('prismjs/prism'), require('prismjs/components/prism-typescript')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/router', '@angular/forms', 'amexio-ng-extensions', '@angular/common/http', 'platform-commons', 'prismjs/prism', 'prismjs/components/prism-typescript'], factory) :
	(factory((global['project-ms-ui'] = {}),global.core,global.common,global.router,global.forms,global.amexioNgExtensions,global.http,global.platformCommons));
}(this, (function (exports,core,common,router,forms,amexioNgExtensions,http,platformCommons) { 'use strict';
...
var CreateProjectComponent = (function () {
    ...
    CreateProjectComponent.ctorParameters = function () { return [
        ...
        { type: platformCommons.LocalStorageService, },
        { type: platformCommons.CookieService, },
        { type: platformCommons.LoaderService, },
        { type: platformCommons.MessagingService, },
        { type: platformCommons.NotificationService, },
...
var TabcodeComponent = (function () {
    ...
    TabcodeComponent.propDecorators = {
        "sourceCode": [{ type: core.Input },],
        "isHtml": [{ type: core.Input },],
        "isJson": [{ type: core.Input },],
        "isTypeScript": [{ type: core.Input },],
        "isCss": [{ type: core.Input },],
        "publicIpAddress": [{ type: core.Input },],
...
var CodeExplorerComponent = (function () {
    ...
    function () {
        ...
        var /** @type {?} */ headers = new http.HttpHeaders({ tokenid: tokenId });
    ...
    ProjectMsUIModule.decorators = [
        { type: core.NgModule, args: [{
                    imports: [
                        common.CommonModule,
                        forms.FormsModule,
                        amexioNgExtensions.AmexioWidgetModule,
                        amexioNgExtensions.AmexioPaneModule,
                        amexioNgExtensions.AmexioFormsModule,
                        http.HttpClientModule,
                        platformCommons.PlatformCommmonsModule.forRoot(),
